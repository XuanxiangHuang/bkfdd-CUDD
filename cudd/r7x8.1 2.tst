...
Memory in use: 2256144
Peak number of nodes: 2044, Peak memory of nodes: 65408
...
Number of cache insertions: 1993
Number of cache collisions: 735
Number of cache deletions: 1255
Cache used slots = 61.43% (expected 62.21%)
...
Runtime Statistics
------------------
Machine name: XuanxiangHUANGs-MacBook-Pro.local
User time      0.0 seconds
System time    0.0 seconds

Average resident text size       =     0K
Average resident data+stack size =     0K
Maximum resident size            = 3248128K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 970
Swaps = 0
Input blocks = 0
Output blocks = 0
